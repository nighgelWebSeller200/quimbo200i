document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "#fe2264"; // Reset to light blue
    ...
    function styleButton(button) {
      button.style.backgroundColor = "#fe2264"; // Light blue background
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#fd3191"; // White background when active
